...
\begin{document}
	...
	- Oil crisis 1970s has demonstrated the impact of oil on economy
	
	- Oil shocks in 90s and early 2000s have not had the same impact as in the 70s \cite{blanchard_macroeconomic_2007}
	
	- Recent energy crisis relunches this question
	
	
	\section{Literature}
	
	Following the oil price induced stagflation crisis of the 1970s a rich body of economic literature has been dedicated to the effects of oil price on inflation and the economy at large \cite{barsky_oil_2002, bernanke_systematic_1997}. The majority of these approaches were empiric. The DSGE literature was the first to translate these findings into a theoretical model. 
	
	In doing so two main approaches were pursued. Early analysis of oil prices and their interaction with the economy introduced petrol as an exogenous supply to the economy. As such models did not distinguish between crude oil and refined petrol imports. Instead, a unified petrol good enters the consumption basket consumption and is used as production input. 
	
	The first model introducing petrol to the DSGE literature is Blanchard \& Galì (2008) \cite{blanchard_macroeconomic_2007}. This work was inspired by the fact that later oil price shocks of similar extend to the 1970s one, did not provoke the same economic response. In order to reconcile the difference in responses under one modelling framework a simple New-Keynesian model was extended by petrol. Across this model imperfectly competitive firms optimise with regards the amount of petrol used in their production. The share of petrol in consumption is assumed to be fixed. The inflationary impact of exogenous petrol price i driven through the elasticity of substitution of oil in production. As oil gets more expensive production costs rise. Firms then substitute petrol inputs for labour across the production, this puts the elasticity of substitution at the heart of the petrol inflation channel.
	In analysing this link further wage rigidities are introduced, limiting the substitution of petrol for labour and thus reinforcing inflationary pressure. 
	This first strain of literature has been extended by later literature in growing the model in complexity. It was shown that the introduction of capital accumulation amplifies the stagflationary effects of petrol on the economy \cite{vasconez_what_nodate}. Advances in mainstream DSGE literature provided better ways of including wage rigidities into DSGE models in introducing wage setting power of households \cite{smets_shocks_2007}. This was used to extend the analysis of wage rigidities in the substitution of production inputs for petrol and \cite{leduc_quantitative_2004}. With petrol entering into the consumption basket, households are able to negotiate higher wages to make up for inflation. This further increases overall inflationary pressure \cite{leduc_quantitative_2004}.
	
	However, this approach to including petrol has several characteristics which to the analysis of short-run shocks are reasonable. A fixed share of petrol in consumption is reasonable in the short run as households struggle to replace the petrol consuming investment goods \cite{blanchard_macroeconomic_2007}. Moreover, a an exogenous petrol price is reasonable for the analysis of shocks as prices surge exogenously. However, as on wishes to analyse the effects of domestic oil production as well as the effects of petrol in the long-run under a non-crisis regime these models leave wholes to be filled.
	
	The second main stream of literature arises from the adoption of DSGE modelling across the many central banks of this world. As these institutions developed complex models tailored to the conditions of the economy petrol was soon introduced as an important factor. Pioneered by the Bank of England (BoE) the small open economy model of the BoE was extend by oil \cite{harrison_evaluating_2010, harrison_impact_2011}. 
	Endogenous oil production is introduced to a small open economy trough a periodic endowment of oil. The model further distinguishes between crude oil and refined petrol in including a petrol sector of production. This is complemented by a utility sector, modelling the effect of gas prices on marginal electricity production. Both refined petrol and utilities then factor into the consumption basket as well as into the domestic production sector. Consequently, the petrol inflation channel assumes a more complex dynamic compared to earlier models. Especially the possibility to trade has important implications since with rising petrol prices the substitution away from oil allows to trade the remaining periodical endowment of oil at the new higher prices. Substitution is thus not only the avoidance of higher cost but itself source of revenue. 
	Ever since, much research has been conducted in tailoring models containing petrol amongst many other factor to the specific dynamics of national economies \cite{lees_introducing_2009, malakhovskaya_are_2014, hou_oil_2016}. 
	
	
	The purpose of this work is the analysis of petrol prices and in their interaction with inflation in light of the recent surge in energy prices. This work will therefore follow the first approach as it is focussing on the interaction of petrol and inflation instead. Later approaches as outlined aim at a comprehensive analysis of the economy as a whole. In doing so many influences are easily confounded, thus allowing for a less clear analysis of the mechanism. 	
